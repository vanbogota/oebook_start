                  ...
                  <div className="flex gap-4 p-4">
                    ...
                    <Image
                      src={`https://api.finna.fi/Cover/Show?${new URLSearchParams({
                        ...
                        title: book.title,
                        recordid: book.id,
                        ...(book.isbn ? ({ invisbn: book.isbn, "isbns[0]": book.isbn } as Record<string, string>) : {}),
                        index: "0",
                      }).toString()}`}
                      alt={book.title}
                      width={64}
                    ...
                    <div className="flex flex-1 max-[450px]:flex-col max-[450px]:gap-2">
                      ...
                      {/* <a href={`https://finna.fi/Record/${book.id}`} className="font-semibold text-lg line-clamp-2 mb-1" target="_blank">{book.title}</a> */}
                      <h3 className="font-semibold text-lg line-clamp-2 mb-1">
                        <a href={`https://finna.fi/Record/${book.id}`} target="_blank">{book.title}</a>
                        {/* {book.title} */}
                      </h3>
